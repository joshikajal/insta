    ...
    if raw['meta']['code'] == 200:
        if len(raw['data'])!=0:
            ...
            if posts!=0:
                ...
                id_s.append(raw)  # append json data
                return id_s
        ...
        if choice == '1':
            ...
            if raw['meta']['code'] == 200:
                if len(raw['data']):
                    ...
                    print "Nsry no user can like the post"
            else:
                print "Error code : %s" % raw['meta']['code']
        elif choice == '2':
